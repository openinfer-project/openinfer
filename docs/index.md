...
| `projects/deepseek-moe-tilelang-review.md` | Active: official TileKernels MoE maps routing/layout, not a drop-in expert MLP; raw NCCL duration was mostly rank arrival skew; persistent DeepSeek rank workers cut 1x32 steady TPOT to `94.84ms/token`; next step is decode-specific grouped/fused routed expert execution. |
