...
| `models/kimi-k2/tp1-dp8-ep8-fusion-scan.md` | Phase 2 fusion scan for TP1 DP8 EP8 decode：H20 NCU 覆盖 `shared_gate_up -> shared_swiglu` 和 `attention input_norm -> qkv_a`；暂无 accepted fusion，下一步是 qkv_a cuBLASLt baseline 或 gated-dual-GEMM prototype。 |
