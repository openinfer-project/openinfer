...
| `models/glm52/serving-status.md` | **Authoritative** GLM5.2 matrix: Blackwell-only; EP4/EP8/EP-N decode (weight-only); TP4 prefill-only; Hopper/TP8/decode-TP removed. Bring-up until indexer + lifecycle gates close. |
