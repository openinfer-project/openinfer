...
| `models/glm52/tp4-gb300-bringup.md` | Active bring-up for serving GLM-5.2-FP8 on one 4xGB300 host with `--tp-size 4`; TP4 now boots, pre-captures graphs, and serves longer, long-prompt, and bucket-8 concurrent completion smokes on GB300. Remaining work is golden/oracle coverage and perf characterization. |
