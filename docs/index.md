...
| `models/qwen35/kv-admission-issue254.md` | Issue #254 complete: Qwen3.5 now uses full-lifetime KV admission, deferred pressure handling, impossible-request rejection, explicit error semantics, fake scheduler-loop rejection/recovery tests, RTX 5090 e2e, and real HTTP pressure/post-pressure validation. |
