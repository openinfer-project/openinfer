...
| `models/glm52/tp4-gb300-bringup.md` | GLM5.2 TP4 on 4xGB300: FlashInfer sparse MLA, compact graphs, SM-selected GEMV/MoE launches, vocabulary-sharded greedy tail. The 07-10 matched pair beat vLLM TP4 (9.03 vs 9.21ms at 1/256, 9.56 vs 9.60 at 1024/256); a 07-11 re-validation reads a flat +0.54ms/step on the OpenInfer path only — host drift, not code (same-day pre/post-rebase A/B flat, vLLM reproduces its record). Functional gates green; re-baseline + TP4 golden open. |
