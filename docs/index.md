...
| `models/glm52/tp4-gb300-bringup.md` | GLM5.2 TP4 on 4xGB300 now beats matched vLLM TP4 at fully warmed bs=1: 9.03 vs 9.21ms (1/256), 9.56 vs 9.60ms (1024/256). FlashInfer sparse MLA, compact graphs, SM-selected GEMV/MoE launches, and a vocabulary-sharded greedy tail are validated by serving, kernel smokes, NCU, and final node-level Nsys; full TP4 golden remains open. |
