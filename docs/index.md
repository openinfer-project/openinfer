...
| `models/kimi-k2/tp1-dp8-ep8-fusion-scan.md` | Phase 2 fusion scan for TP1 DP8 EP8 decode：首个 H20 NCU 证据覆盖 `shared_gate_up -> shared_swiglu`，row 22 是 tiny-grid/latency-bound；cuBLASLt 不能表达 SwiGLU cross-output epilogue，暂无 accepted fusion。 |
