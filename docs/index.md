...
| `models/glm52/megamoe-evaluation.md` | DeepGEMM SM100 MegaMoE as sole-Blackwell-EP-backend candidate: Phase-0 microbench at GLM shapes on GB300 EP4 shows flat 180-206µs/layer decode floor (clock-locked fp8×fp4) vs our chain's 169µs b1 slice — parity at b1, projected b8 win + skew absorption; methodology, pitfalls, and decision framework inside. |
