...
| `benchmarks/qwen35-4b-serving-vllm-rtx5090.md` | Qwen3.5-4B TP1 vs vLLM 0.23.0 on RTX 5090 (2026-06-15, @`f3dcdf4`), README source: fixed HTTP `vllm bench serve` n=30/warm1; openinfer TTFT p50 leads on 2048/1 (101.8 vs 115.2 ms) and 1024/256 (53.7 vs 67.4 ms), while vLLM leads decode TPOT (6.32 vs 7.31 ms) and output tok/s (152.3 vs 133.6). |
