...
The refactor (issue #256) adds a qwen35 counterpart: a `src/kernel_plan.rs` module that mirrors the qwen3 structure and is exposed via `openinfer_qwen35_4b::kernel_plan()`.
