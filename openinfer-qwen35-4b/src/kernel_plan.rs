    ...
    phases: &[
        ...
        KernelPhase {
            ...
            ops: &[
                ...
                KernelOp {
                    ...
                    notes: "greedy rows use indexed batched argmax; stochastic rows keep the existing per-row sampler",
                },
            ],
        },
        // ── Unified ─────────────────────────────────────────────────────────
        ...
        KernelPhase {
            ...
            ops: &[
                ...
                KernelOp {
                    id: "logprobs_snapshot",
                    rust: "logprobs::snapshot_requested_logprobs -> ops::extract_vec",
                    backend: "CUDA (cudarc D2D memcpy)",
                    notes: "only runs for rows whose request asks for logprobs; no-logprobs decode samples directly from batched logits",
                },
            ],
        },
    ],
