...
use pegainfer_core::engine::RequestAbortReason;
use pegainfer_core::engine::RequestTag;
use pegainfer_core::engine::TokenEvent;
use pegainfer_core::engine::TokenSink;
use pegainfer_core::engine::TokenStreamReceiver;
use pegainfer_core::engine::TokenStreamSender;
...
fn start_pin_engine(model_path: &str) -> EngineHandle {
    let handle = pegainfer_qwen3::start_engine_with_offload(
        Path::new(model_path),
        EngineLoadOptions {
