...
enum RankCommand {
    ...
    #[cfg(feature = "pplx-ep")]
    EnablePplx {
        ep_backend: openinfer_comm::EpBackend,
        resp: channel::Sender<Result<()>>,
    },
    Shutdown,
}
...
struct RankDecodeScratch {
    ...
    #[cfg(feature = "pplx-ep")]
    ep_backend: Option<openinfer_comm::EpBackend>,
...
impl RankWorker {
    ...
    #[cfg(feature = "pplx-ep")]
    fn enable_pplx(&self, ep_backend: openinfer_comm::EpBackend) -> Result<()> {
        let (resp_tx, resp_rx) = channel::bounded(1);
        self.tx
...
impl FullDirectRuntime {
    ...
    #[cfg(feature = "pplx-ep")]
    pub(super) fn enable_pplx(&self, ep_backends: Vec<openinfer_comm::EpBackend>) -> Result<()> {
        ensure!(
