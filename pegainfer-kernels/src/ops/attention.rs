...
pub fn qk_norm_partial_rope_paged_prefill_hd512_into(
    ...
    ensure_hidden_capacity(q, "hd512 prefill prep q")?;
    ensure_hidden_capacity(q_out, "hd512 prefill prep q_out")?;
    ensure_hidden_capacity(k, "hd512 prefill prep k")?;
...
pub fn qk_norm_partial_rope_batched_decode_hd512_into(
    ...
    ensure_hidden_capacity(q, "hd512 decode prep q")?;
    ensure_hidden_capacity(q_out, "hd512 decode prep q_out")?;
    ensure_hidden_capacity(k, "hd512 decode prep k")?;
