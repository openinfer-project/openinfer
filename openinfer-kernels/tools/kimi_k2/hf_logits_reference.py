...
This is the parity source for OpenInfer full-model logits gates. It intentionally
...
def patch_kimi_remote_code_init_weights(model_load_path: Path) -> str:
    ...
    if getattr(base_cls, "_openinfer_compressed_init_patch", False):
        return module_name
    ...
    base_cls._openinfer_compressed_init_patch = True
    return module_name
