...
///
/// This is intended for narrow numerical transaction boundaries that must not
/// depend on which near-equal small-N algorithm won startup timing. Other
/// threads and the normal tuned decode path are unchanged.
