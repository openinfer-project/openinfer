// GLM5.2 sixteen-GPU DeepEP config (DP1/EP16, 4 GB300 NVL72 trays): 256
// routed experts place 16 whole experts per rank.
//
...
namespace deepep_shim::cfg_glm52_ep16 {

// Model / topology (GLM5.2, DP1/EP16).
inline constexpr int kNumRanks = 16;
inline constexpr int kNumExperts = 256;
inline constexpr int kNumLocalExperts = kNumExperts / kNumRanks;  // 16
