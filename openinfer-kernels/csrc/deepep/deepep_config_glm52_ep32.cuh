// GLM5.2 thirty-two-GPU DeepEP config (DP1/EP32, 8 GB300 NVL72 trays): 256
// routed experts place 8 whole experts per rank.
//
...
namespace deepep_shim::cfg_glm52_ep32 {

// Model / topology (GLM5.2, DP1/EP32).
inline constexpr int kNumRanks = 32;
inline constexpr int kNumExperts = 256;
inline constexpr int kNumLocalExperts = kNumExperts / kNumRanks;  // 8
