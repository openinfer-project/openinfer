// GLM5.2 single-node 8×H200 DeepEP config: compile-time constants and the
// warp-count derivations that feed kernel template parameters.
//
// The derivations mirror the upstream JIT host logic exactly
// (csrc/kernels/elastic/{dispatch,combine}.hpp); glm52_deepep_ctx_create
...
namespace deepep_glm52_shim::cfg {

// Model / topology (GLM5.2, TP1/DP8/EP8).
...
// Match DeepGEMM SM90 MGroupedContiguousWithPsumLayout when the runtime
// alignment is set to 64; this avoids a post-DeepEP repack before W13/W2 GEMM.
inline constexpr int kExpertAlignment = 64;
