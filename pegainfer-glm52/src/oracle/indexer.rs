...
//!    --ctx 4096 --seed 0x5eed604d --layer 0 --precision gemv --stage indexer --emit safetensors \
...
use crate::indexer::glm52_indexer_cache_fill;
...
//     --ctx 4096 --seed 0x5eed604d --layer 0 --precision gemv --stage indexer
...
fn indexer_oracle_gate() -> Result<()> {
    ...
    let probes_path = std::env::var_os("PEGAINFER_ORACLE_PROBES_PATH").map_or_else(
    ...
    // ---- cache setup ----
    let cache_blocks = ORACLE_CTX.div_ceil(INDEX_CACHE_BLOCK);
