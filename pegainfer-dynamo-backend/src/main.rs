//! Dynamo backend worker serving pegainfer (Qwen3).
//!
//! Standalone binary, intentionally NOT a member of the main pegainfer
//! workspace — plain single-machine pegainfer (`cargo run --release --
...
fn main() -> anyhow::Result<()> {
    let (backend, config) = engine::PegainferBackend::from_args()?;
