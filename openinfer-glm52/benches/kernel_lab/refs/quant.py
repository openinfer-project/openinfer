...
The scalar helpers are the torch-free spec mirror exercised by the CPU tests
(benches/tests/test_quant.py); the tensor functions lazily import torch per
the kernel_lab contract.
"""
