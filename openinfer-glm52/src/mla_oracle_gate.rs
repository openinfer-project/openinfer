...
// Placeholder until the harness runs; the gate fails on the input digest
// first, so an all-zero probe block cannot silently pass.
const ORACLE_SEED: u64 = 0x5EED_604D;
const ORACLE_CTX: usize = 200;
const ORACLE_HIDDEN_DIGEST: &str = "0000000000000000";
const ORACLE_O_RMS: f32 = 0.0;
