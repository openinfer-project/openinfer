...
- **FlashInfer source** — repo-local submodule at `pegainfer-kernels/third_party/flashinfer`; initialize it with `git submodule update --init --recursive pegainfer-kernels/third_party/flashinfer` before inspecting FlashInfer kernels.
